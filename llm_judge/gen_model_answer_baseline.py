...
def hydra_forward(input_ids, model, tokenizer, hydra_choices, temperature, posterior_threshold, posterior_alpha, max_steps = 512):
    ...
    # hydra_logits, logits = initialize_hydra(
    #         input_ids, model, hydra_buffers["hydra_attn_mask"], past_key_values
    # )
    ...
    for idx in range(max_steps): 
        ...
        #         hydra_logits,
        #         logits,
        #         hydra_buffers["tree_indices"],
        #         hydra_buffers["retrieve_indices"],
        #     )
        # hydra_logits, logits, outputs = tree_decoding(
        #         model,
        #         tree_candidates,
        #         past_key_values,
        ...
        #     )
        # input_ids, logits, hydra_logits, new_token = update_inference_inputs(
        #         input_ids,
        #         candidates,
        #         best_candidate,
        #         accept_length,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base-model-id", type=str, default="lmsys/vicuna-7b-v1.3")
    parser.add_argument(
        "--bench-name",
        type=str,
        default="mt_bench",
